...
import torch
from intervention import addCounterFactualIntervation
...
class BertEncoderForProbing(nn.Module):
    ...
    def forward(
        ...
        for i, layer_module in enumerate(self.layer):
            ...
            hidden_states = addCounterFactualIntervation(
                h=hidden_states,
                l=i,
                layers=self.config.PROBE_LAYERS,
                i=self.config.TOKEN_IDX,
                k=self.config.K,
...
class BertForMaskedLMProbing(BertPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.bert = BertModelforProbing(config, add_pooling_layer=False)
